...
import { recentNFTsData } from "./data/dashboardNFT";
import { topCollectionData } from "./data/dashboardNFT";
import { popularCreatorsData } from "./data/dashboardNFT";
                ...
                <Col xxl={4} >
                    <Card>
                        <CardHeader className="d-flex align-items-center">
                            <h6 className="card-title flex-grow-1 mb-0">Top Users</h6>
                            <Link type="button" className="btn btn-soft-primary shadow-none btn-sm flex-shrink-0">
