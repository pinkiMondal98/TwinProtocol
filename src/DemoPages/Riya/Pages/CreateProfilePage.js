...
import { Card, FormFeedback, CardBody, Col, Container, Input, Label, Row,Button } from 'reactstrap';
...
const CreateProfilePage = () => {
    document.title = "SignUp | Mindplex";
  ...
  const history = useNavigate();
    const logo = "	https://sophia-verse-demo.vercel.app/static/media/mindplex.9da1e1e8b17dec4708510a3985fbb990.svg"
                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={sophiaLogo} alt="" height="60" />
                                        </Link>
                                    </div>
                                    <p className="mt-3 text-white fs-15 fw-medium">Give Food A Second Chance</p>
                                </div>
                            </Col>
                        </Row>
                                        ...
                                        <div className="p-2 mt-4">
                                            <form className="needs-validation" action="#">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="email" className="form-control" id="useremail" defaultValue="jones@gmail.com" disabled />
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Mindplex
                                                ...
                                                <div className="mt-4">
                                                    <button onClick={() => {history('/login')}} className="btn btn-success w-100" type="submit">Sign Up</button>
                                                </div>
