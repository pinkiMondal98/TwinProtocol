                ...
                <Col lg={12}>
                  <div className="text-center mt-sm-5 mb-4 text-white-50">
                    <div>
                      ...
                      >
                        <h1 className="text-dark text-white">Mindplex</h1>
                      </Link>
                    </div>
                    {/* <p className="mt-3 fs-15 fw-medium text-dark">Optionality and Infinite Games</p> */}
                  </div>
                </Col>
              </Row>
                          ...
                          <Row>
                            <Col className="col-2">
                              <div className="mb-3">
                                ...
                                <input
                                  type="text"
                                  className="p-3 form-control form-control-lg bg-light border-light text-center"
                                  maxLength="1"
                                  id="digit1-input"
